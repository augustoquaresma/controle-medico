...
public class EspecialidadeController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<EspecialidadeDTO> updateEspecialidade(@RequestBody PostEspecialidade especialidade, @PathVariable Long id){
		return new ResponseEntity<>(especialidadeService.updateEspecialidade(especialidade, id), HttpStatus.OK);
	}
